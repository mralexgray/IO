...
void completion(const char *buf, linenoiseCompletions *lc) { if (buf[0] != 'h') return;

  linenoiseAddCompletion(lc,"hello"); linenoiseAddCompletion(lc,"hello there");
}

int main(int argc, char **argv) { char *line, *prgname = argv[0];
